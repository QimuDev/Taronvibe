...
<nav>
      ...
      <div class="nav-profile">
        <ul class="nav-list">
          ...
          <li class="nav-item">
            <a href="listadoOrganizadores.php">Organizadores</a>
          </li>
          <li>
            <a href="userProfile.php">
              <button class="btn-profile">
                <img src="./img/img_userUpdate/Vector.svg" alt="svg perfil" />
                Mi Perfil
              </button>
            </a>
          </li>
    ...
    <section class="contenedor">
        ...
        <div class="texto">
            ...
            <div class="info">
                <a href="#">Web oficial del organizador</a>
                <p>Lorem ipsum odor amet, consectetuer adipiscing elit. Nascetur euismod orci auctor, malesuada urna ultricies imperdiet! Erat maximus tincidunt nullam augue semper luctus. Ante tortor tortor dis mi pulvinar tristique ligula integer id.</p>
            </div>
        </div>
    </section>
    <section class="eventos">
      ...
      <div class="galery-button"><button>Ver más eventos</button></div>
    </section>
</section>
